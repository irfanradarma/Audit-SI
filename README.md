...
<body class="bg-gray-100 font-sans text-gray-800">
    ...
    <div class="container mx-auto max-w-7xl p-4 sm:p-6 md:p-10">
        ...
        <main class="bg-white rounded-xl shadow-md overflow-hidden">
            ...
            <div class="p-6 border-b border-gray-200">
                ...
                <a href="https://github.com/irfanradarma/Audit-SI/blob/main/ASP%20STR_2514926D_Audit%20Sistem%20Informasi.pdf" 
                   ...
                   class="inline-flex items-center gap-2 bg-blue-600 text-white font-semibold py-2 px-5 rounded-lg hover:bg-blue-700 transition-colors duration-200 shadow-sm">
                ...
                <div class="overflow-x-auto rounded-lg border border-gray-200">
                    <table class="w-full min-w-[600px] border-collapse">
                        ...
                        <tbody class="divide-y divide-gray-200">
                            ...
                            <!-- Row 7: Review -->
                            <tr class_="" ="hover:bg-gray-50 even:bg-gray-50">
                                <td class="p-3">7</td>
